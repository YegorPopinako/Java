...
public class Decoder {
    ...
    public static boolean isConsonant(char c, char[] consonants) {
        // Check if the character is a consonant by searching in the array
    ...
    public static char getNextConsonant(char c, char[] consonants) {
        // Find the index of the current consonant in the array
        int currentIndex = -1;
        ...
        // Get the next consonant in the array (cycling back to the start if needed)
